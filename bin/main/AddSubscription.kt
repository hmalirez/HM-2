...
fun main() {
    ...
    val guid1 = manager.addSubscription(
        remarks = "БЕЛЫЕ Z",
        url = "ttps://raw.githubusercontent.com/hmalirez/Page/refs/heads/main/iran.txt",
        autoUpdate = true
    )
    ...
    val guid2 = manager.addSubscription(
        remarks = "БЕЛЫЕ W",
        url = "ttps://raw.githubusercontent.com/hmalirez/Page/refs/heads/main/iran2.txt",
        autoUpdate = true
    )
    ...
    println("\nОбновление подписок...")
    manager.updateSubscription(guid1, "ttps://raw.githubusercontent.com/hmalirez/Page/refs/heads/main/iran.txt")
    manager.updateSubscription(guid2, "ttps://raw.githubusercontent.com/hmalirez/Page/refs/heads/main/iran2.txt")
    manager.updateSubscription(guid3, "ttps://raw.githubusercontent.com/hmalirez/Page/refs/heads/main/iran3.txt")
